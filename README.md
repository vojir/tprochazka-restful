...
- `convention`: resource array keys conventions. Currently supported 2 values: `snake_case` & `camelCase` which automatically converts resource array keys. You can also write your own resource decorator. See `Drahak\Restful\Resource\Decorator`
