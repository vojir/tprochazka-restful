...
class Extension extends CompilerExtension
{
	...
	public function loadConfiguration()
	{
		...
		if ($config['security']['requestTimeout']) {
			$container->addDefinition($this->prefix('requestAuthenticator'))
				->setClass('Drahak\Restful\Security\TimeoutAuthenticator')
				->setArguments(array($config['security']));
		} else {
			$container->addDefinition($this->prefix('requestAuthenticator'))
				->setClass('Drahak\Restful\Security\RequestAuthenticator')
				->setArguments(array($config['security']));
		}
