...
class RestExtension extends CompilerExtension
{
	...
	public function loadConfiguration()
	{
		...
		// Add input parsers
		$container->addDefinition($this->prefix('getInput'))
			->setClass('Drahak\Restful\Input\GetInput');
		$container->addDefinition($this->prefix('postInput'))
			->setClass('Drahak\Restful\Input\PostInput');
		$container->addDefinition($this->prefix('putInput'))
			->setClass('Drahak\Restful\Input\PutInput');
		$container->addDefinition($this->prefix('deleteInput'))
			->setClass('Drahak\Restful\Input\DeleteInput');
		$container->addDefinition($this->prefix('headInput'))
			->setClass('Drahak\Restful\Input\HeadInput');

		$container->addDefinition($this->prefix('inputContext'))
			->setClass('Drahak\Restful\Input\InputContext')
			->addSetup('$service->addInput(?)', array($this->prefix('@getInput')))
			->addSetup('$service->addInput(?)', array($this->prefix('@postInput')))
			->addSetup('$service->addInput(?)', array($this->prefix('@putInput')))
